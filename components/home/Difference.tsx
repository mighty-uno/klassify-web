  ...
  return (
    <section id="why" className="section-pad bg-night text-white">
      <div className="container-page">
        <Reveal>
          <SectionLabel index="01" title="The SkooBee difference" light />
          ...
          <p className="mt-4 max-w-2xl text-[17px] leading-relaxed text-muted-3">
            Teachers teach. Office teams support. SkooBee keeps attendance,
            billing, schedules, and day-to-day operations moving quietly in the
            background.
          </p>
        </Reveal>
