...
export const metadata: Metadata = {
  ...
  description:
    "How SkooBee collects, uses, and protects the information of schools, staff, students, and parents."
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      eyebrow="Legal"
      title="Privacy Policy"
      intro="This Privacy Policy explains how SkooBee, operated by Vidhiworks, collects, uses, stores, and protects information when schools, teachers, students, and parents use our AI-powered school operating system and website."
      lastUpdated={siteConfig.lastUpdated}
    >
      <h2>1. Who we are</h2>
      <p>
        SkooBee is an AI-powered school operating system provided by{" "}
        ...
        &ldquo;SkooBee&rdquo; in this policy, we mean {siteConfig.companyName}.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          SkooBee, it provides us with school records including class structures, staff
      ...
      <ul>
        <li>To provide, operate, and maintain the SkooBee service your school subscribes to.</li>
      ...
      <p>
        SkooBee uses AI to reduce repetitive work, surface useful patterns, and generate
      ...
      <ul>
        <li>
          ...
          has configured for them through SkooBee.
        </li>
        <li>
      ...
      <p>
        SkooBee is designed for use by schools. Student information is provided by the
